function [ lnratio_approx,Ap_approx,Bp,A_approx,Gp_approx ] = MCMC_alpha_approx( p, y, G_approx, sigma, gamma, mu0, Au_approx, Bu )
...
Ap_approx=(y-Gp_approx)'*diag(1./(sigma.^2))*(y-Gp_approx)/2;
