function [ Q_all ] = observation_windows( A,b_,freeNode_,u0_,downEdge_,rightEdge_,upEdge_,leftEdge_,fracture_matrice,intersections,alfa_inter,lengths,node,elem,h_elem,p,mat_frac,chosen_windows,ln_d,data_generator,n_windows )
