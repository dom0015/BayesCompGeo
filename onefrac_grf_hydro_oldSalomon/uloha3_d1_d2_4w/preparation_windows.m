function [ A,b,freeNode,u0,downEdge,rightEdge,upEdge,leftEdge,fracture_matrice,intersections,alfa_inter,lengths,node,elem,h_elem,p,mat_frac ] = preparation_windows(n_windows)
%% FEM with fractures
...
windows_type=2; % number of configuration of Dirichlet windows
