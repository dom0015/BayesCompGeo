function [ G_approx, log_approx, evaluated_Gu_mh ] = MCMC_approx_dcg( u,y,sp,sigma,gamma,mu0,g,N,period_saving,batch,label,evaluated_u_init,evaluated_Gu_init,upgrade_approx,approx_type )
...
if approx_type==2
    solver_=@(A,b)PDCG(A,b,[],W,[],sp.prec,sp.cg_accuracy,0);
