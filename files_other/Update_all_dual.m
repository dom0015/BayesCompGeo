function [F,ff,G,c_ker,update_temp_struct,geom_res,x_elast,alpha] = Update_all_dual(lambda_ker,idx_no_bounds,idx_bounds,c,B_e,A_plus,b,R,B_iupdate,update_temp_struct)
